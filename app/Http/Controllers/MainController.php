...
class MainController extends Controller
{
    public function index()
    {
        ...
        $positions = Position::select('name')->where('name', '南京钢管分公司')->orWhere('name', '防腐分公司')->orWhere('name', '科技质量中心')->groupBy('name')->orderByRaw('MIN(sort)')->get();
        ...
        $check = SupervisionController::show(implode(',', $check_id), true);
        //检定计划
        ...
        return view("main.index", compact('start_year', 'end_year', 'start_month', 'end_month', 'check', 'check_count', 'pdf_count', 'certificates', 'year_plan', 'month_plan', 'plans', 'standbys', 'positions'));
    }
}

        ...
        <div role="tabpanel" class="tab-pane @if($certificate->valid==0) show active @endif" id="edit-tab" aria-labelledby="edit-btn">
            <form action="" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    @include('template.input',['tmp_name'=>'position_id','tmp_label'=>'岗位','tmp_value'=>$certificate->position1,'tmp_state'=>'disabled','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'sn','tmp_label'=>'序号','tmp_value'=>$certificate->sn,'tmp_state'=>'readonly','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'tool_id','tmp_label'=>'器具名称','tmp_value'=>$certificate->instrument,'tmp_state'=>'disabled','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'model','tmp_label'=>'规格型号','tmp_value'=>$certificate->model,'tmp_state'=>'readonly','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'factory_id','tmp_label'=>'生产厂家','tmp_value'=>$certificate->factory,'tmp_state'=>'disabled','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'limit','tmp_label'=>'测量范围','tmp_value'=>$certificate->limit,'tmp_state'=>'readonly','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'number_id','tmp_label'=>'出厂编号','tmp_value'=>$certificate->number,'tmp_state'=>'disabled','tmp_col'=>'6'])
                    @include('template.input',['tmp_name'=>'accuracy','tmp_label'=>'精确度','tmp_value'=>$certificate->accuracy,'tmp_state'=>'readonly','tmp_col'=>'6'])
                    @include('template.select',['tmp_name'=>'department_id','tmp_label'=>'检定部门','tmp_items'=>$departments,'tmp_selected'=>$certificate->department_id,'tmp_validate'=>'id','tmp_value'=>'id','tmp_field'=>'name','tmp_col'=>'6'])
                    ...
                    @include('template.select-picker',['tmp_name'=>'standard_id[]','tmp_label'=>'检定标准','tmp_items'=>$standards,'tmp_selected'=>$certificate->standards,'tmp_validate'=>'id','tmp_value'=>'id','tmp_field1'=>'name2','tmp_field2'=>'name1','tmp_state'=>'multiple','tmp_col'=>'6'])
            ...
            @else
                ...
                @if($spares->count()!=0)
                    <div role="tabpanel" class="tab-pane show active" id="spare-tab" aria-labelledby="spare-btn">
                        ...
                        @include('template.table',['tmp_menu'=>"certificate",'tmp_headers'=>['','序号','器具名称','规格型号','出厂编号','检定日期','有效期','检定部门','备注'],'tmp_id'=>'off-sidebar','tmp_class'=>'table-data','tmp_items'=>$spares])

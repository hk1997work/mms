...
@section('content_form')
    <div class="row">
        ...
        @include('template.select-btn',['tmp_name'=>'factory_id','tmp_label'=>'生产厂家','tmp_class'=>'factory_add','tmp_menu'=>'factory','tmp_state'=>'disabled','tmp_reload'=>'tool_id','tmp_col'=>'6'])
        @include('template.input',['tmp_name'=>'limit','tmp_label'=>'测量范围','tmp_col'=>'6','tmp_state'=>'readonly'])
        @include('template.select-btn',['tmp_name'=>'number_id','tmp_label'=>'出厂编号','tmp_class'=>'number_add','tmp_menu'=>'number','tmp_state'=>'disabled','tmp_reload'=>'factory_id','tmp_col'=>'6'])

                        ...
                        @foreach($permissions->where('pid',$permission_1->id) as $permission_2)
                            <div class="ml-5">
                                ...
                                @foreach($permissions->where('pid',$permission_2->id) as $permission_3)
                                    <div class="ml-5">
                                        <div class="styled-checkbox">
                                            <input type="checkbox" name="permission[]" id="permission{{$permission_3->id}}" data-pid="permission{{$permission_3->pid}}" data-ppid="permission{{$permission_2->pid}}" value="{{$permission_3->id}}" @if($myPermissions!=''&&$myPermissions->contains($permission_3)) checked @endif>

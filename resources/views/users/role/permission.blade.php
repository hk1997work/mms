    ...
    <div class="table-responsive" style="max-height:500px;">
        @foreach($permissions as $permission_1)
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3 row d-flex align-items-center" style="border-bottom: 1px solid;">
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                    @foreach($permission_1->toChildrens as $permission_2)
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3 mt-3 row d-flex align-items-center" @if($permission_2 !=$permission_1->toChildrens[sizeof($permission_1->toChildrens)-1]) style="border-bottom: 1px solid;" @endif>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                @foreach($permission_2->toChildrens as $permission_3)
        ...
        @foreach($positions as $position_1)
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3 row d-flex align-items-center" style="border-bottom: 1px solid;">
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                    @foreach($position_1->toChildrens as $position_2)
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3 mt-3 row d-flex align-items-center" @if($position_2 !=$position_1->toChildrens[sizeof($position_1->toChildrens)-1]) style="border-bottom: 1px solid;" @endif>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 styled-checkbox">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                @foreach($position_2->toChildrens as $position_3)
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 row styled-checkbox">

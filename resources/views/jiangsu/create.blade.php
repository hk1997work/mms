        ...
        <div class="form-group row mb-5 mt-5">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3 div-group[{{$certificate['json']->zsId}}][factory_id]">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-addon addon-primary btn-add factory_add" data-pos='right' data-menu='factory' data-cb="group[{{$certificate['json']->zsId}}][tool_id]" @if($certificate['info']) data-id="{{$certificate['tool_id']}}&name={{$certificate['json']->zsZzc}}" @else hidden @endif>增加</span>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3 div-group[{{$certificate['json']->zsId}}][number_id]">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-addon addon-primary btn-add number_add" data-pos='right' data-menu='number' data-cb="group[{{$certificate['json']->zsId}}][factory_id]"
                          @if($certificate['info']) data-id="{{$certificate['factory_id']}}&name={{isset($certificate['json']->zsCcbh)?$certificate['json']->zsCcbh=='/'?'':$certificate['json']->zsCcbh:''}}{{isset($certificate['json']->zsSbbh)?$certificate['json']->zsSbbh=='/'?'':$certificate['json']->zsSbbh:''}}"

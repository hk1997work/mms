...
@section('content_title')
    <li><a class="active" data-toggle="tab" href="#jiangsu-tab" role="tab" id="jiangsu-btn">屏蔽列表</a></li>
@endsection
@section('content_form')
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane show active fade" id="jiangsu-tab" aria-labelledby="jiangsu-btn">
            <div class="col-12 ckp">
                <div class="btn-group mb-3">
                    <ul class="button-nav nav nav-tabs mt-3 mb-3 ml-3" role="tablist">
                        <li><a class="btn-delete check-multiple" data-menu="jiangsu" data-pos="right" href="#">删除</a></li>
                ...
                <table id="off-sidebar-table" data-menu="jiangsu_show" class="table table-hover mb-0">
                    <thead>
                    <tr>
                        <th style="width:5%;">
